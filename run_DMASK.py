...
test_9411result_dir = os.path.join(root_dir, "RTTS/9411result")
test_file_dir = os.path.join(root_dir, "RTTS/Annotations")
for path, dirs, files in os.walk(test_image_dir):
    test_image_names = sorted(files)
    break
...
cur_mAP2 = mAP_test(test_image_dir  , test_file_dir)
